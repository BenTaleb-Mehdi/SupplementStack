...
@section('title', 'Order Confirmed - Mini Market')
        ...
        <div class="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="p-8 md:p-10">
                <div class="text-center mb-10">
                    <p class="text-gray-600">Your order <span class="font-bold text-gray-900">#{{ $order->id }}</span> has been placed successfully.</p>
                    <p class="text-gray-500 text-sm mt-1">We've sent a confirmation email to <span class="font-medium text-gray-700">{{ Auth::user()->email }}</span></p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-sm">
                        ...
                        <div class="flex justify-between md:block">
                         ...
                         <div class="flex justify-between md:block">
                            ...
                            <span class="font-bold text-primary-600 text-lg">{{ App\Models\Setting::formatPrice($order->total_amount) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('orders.show', $order) }}" class="inline-flex justify-center items-center px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                        View Order Details
                    </a>
                    <a href="{{ route('products.list') }}" class="inline-flex justify-center items-center px-8 py-3 border border-transparent text-base font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-700 shadow-lg hover:shadow-primary-500/30 transition-all transform hover:-translate-y-0.5">
                        Continue Shopping
                    </a>
                </div>
            </div>
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 text-center">
                <p class="text-sm text-gray-500">Need help? <a href="{{ route('contact') }}" class="text-primary-600 hover:text-primary-700 font-medium">Contact Support</a></p>
            </div>
        </div>
    </div>
</div>
