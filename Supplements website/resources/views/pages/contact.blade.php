                    ...
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 text-sm">{{ App\Models\Setting::get('contact_email', 'hello@minimarket.com') }}</p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 text-sm leading-relaxed">{{ App\Models\Setting::get('store_address', '123 Wellness Ave, Casablanca, Morocco') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
