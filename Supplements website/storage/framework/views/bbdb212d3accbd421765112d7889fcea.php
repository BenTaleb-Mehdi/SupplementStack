<?php $__env->startSection('title', 'Mini Market - Premium Health & Wellness'); ?>

<?php $__env->startSection('content'); ?>
<!-- Hero Section -->
<div class="relative <?php echo e(App\Models\Setting::get('home_hero_height', 'min-h-[95vh]')); ?> flex items-center bg-white overflow-hidden">
    
    <div class="absolute inset-0 z-0">
        <?php $homeHeroImage = App\Models\Setting::get('home_hero_image'); ?>
        <img class="w-full h-full object-cover transition-transform duration-[10s] hover:scale-110" 
             src="<?php echo e($homeHeroImage ? asset('storage/' . $homeHeroImage) : 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop'); ?>" 
             alt="Athlete Fitness">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex flex-col items-start gap-8">
            ...
            <div class="backdrop-blur-md bg-white/10 border border-white/20 px-4 py-2 rounded-full flex items-center gap-3">
                ...
                <span class="text-[10px] font-bold text-white uppercase tracking-[0.3em]"><?php echo e(App\Models\Setting::get('home_hero_badge', 'Scientific Performance')); ?></span>
            </div>

            <div class="space-y-2">
                <h1 class="text-6xl md:text-[7rem] font-black text-white leading-none tracking-tighter drop-shadow-2xl">
                    <?php echo App\Models\Setting::get('home_hero_title', 'PUSH <br> <span class="text-primary-500">BEYOND.</span>'); ?>
            ...
            <div class="backdrop-blur-xl bg-black/30 border border-white/10 p-8 rounded-[2rem] max-w-xl">
                <p class="text-gray-100 text-lg font-light leading-relaxed">
                    <?php echo e(App\Models\Setting::get('home_hero_subtitle', 'Premium formulas designed for those who measure success in sweat and results. Your elite journey starts with the right fuel.')); ?>
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="#products" class="bg-white text-black px-10 py-4 rounded-full font-black uppercase text-xs tracking-widest hover:bg-primary-500 hover:text-white transition-all shadow-xl shadow-black/20">
                        <?php echo e(App\Models\Setting::get('home_hero_cta_text', 'Shop Now')); ?>
        ...
        <?php if($categories->count() > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('products.list', ['category' => $category->slug])); ?>" 
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($promo->product && $promo->product->is_active): ?>
                <div class="group flex flex-col h-full relative">
                    <div class="absolute top-4 left-4 z-20">
                        <span class="bg-red-600 text-white text-[10px] font-black px-4 py-1.5 rounded-full tracking-widest shadow-xl">
                            -<?php echo e($promo->discount_percentage); ?>%
                        </span>
                    </div>
                    ...
                    <div class="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] bg-slate-50 border border-slate-100 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-slate-200">
                        <?php if($promo->product->image): ?>
                            <img src="<?php echo e($promo->product->image_url); ?>" alt="<?php echo e($promo->product->name); ?>" 
                        ...
                        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                            <a href="<?php echo e(route('products.show', $promo->product)); ?>" class="bg-slate-900 text-white px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest whitespace-nowrap shadow-2xl">
                                Quick Shop
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 space-y-3 px-2">
                        <h3 class="text-xl font-black text-slate-900 tracking-tight group-hover:text-primary-600 transition-colors line-clamp-1 italic uppercase">
                            <?php echo e($promo->product->name); ?>

                        </h3>
                        
                        <div class="flex items-center gap-3">
                            <span class="text-2xl font-black text-slate-900">
                                <?php echo e(\App\Models\Setting::formatPrice($promo->discounted_price)); ?>

                            </span>
                            <span class="text-sm text-slate-400 line-through font-light">
                                <?php echo e(\App\Models\Setting::formatPrice($promo->product->price)); ?>
                        ...
                        <div class="flex items-center gap-2 pt-2">
                            <div class="flex-1 h-[2px] bg-slate-100">
                                <div class="h-full bg-slate-900 transition-all duration-1000" style="width: <?php echo e(min(($promo->product->stock / 50) * 100, 100)); ?>%"></div>
                            </div>
                            <span class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                                <?php echo e($promo->product->stock); ?> Left
                            </span>
                        </div>
                    </div>
                </div>
...
<section id="products" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6">
            ...
            <a href="<?php echo e(route('products.list')); ?>" class="group flex items-center gap-3 text-slate-900 font-bold uppercase text-[10px] tracking-widest border-b-2 border-slate-900 pb-2 hover:border-primary-500 transition-all">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group flex flex-col h-full">
                        ...
                        <div class="relative aspect-[1/1] mb-8 bg-slate-50 rounded-[2.5rem] overflow-hidden transition-all duration-500 group-hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]">
                            ...
                            <div class="absolute inset-0 bg-slate-950/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                <?php if($product->stock > 0): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>" class="bg-white text-slate-900 px-8 py-3 rounded-full font-black text-[10px] uppercase tracking-widest shadow-2xl">
                                            Login to Shop
                                        </a>
                                    <?php endif; ?>
                                <?php endif; ?>
                        ...
                        <div class="flex flex-col flex-1 px-2 text-center">
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2"><?php echo e($product->category->name ?? 'Supplement'); ?></p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div class="group">
                        ...
                        <p class="text-xl font-bold text-slate-900 group-hover:text-primary-600 transition-colors">
                            <?php echo e(App\Models\Setting::get('contact_phone', '+1 (555) 123-4567')); ?>
                    ...
                    <div class="group">
                        ...
                        <p class="text-xl font-bold text-slate-900 group-hover:text-primary-600 transition-colors underline decoration-slate-200 underline-offset-8">
                            <?php echo e(App\Models\Setting::get('contact_email', 'hello@minimarket.com')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\CascadeProjects\Market-Store - v2\mini-market\resources\views/products/index.blade.php ENDPATH**/ ?>