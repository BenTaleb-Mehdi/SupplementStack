<?php $__env->startSection('title', 'Orders Management - Admin Dashboard'); ?>
<?php $__env->startSection('page-title', 'Orders Management'); ?>
<?php $__env->startSection('page-description', 'Manage customer orders and purchases'); ?>
...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($orders->where('payment_status', 'pending')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($orders->where('payment_status', 'paid')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($orders->where('payment_status', 'failed')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($orders->total()); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
        <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>" class="space-y-4" id="ordersFilterForm">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                ...
                <p class="text-sm text-gray-600"><?php echo e($orders->total()); ?> total orders</p>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-3 sm:px-6 py-4">
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">#<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?></div>
                                        <!-- Mobile info -->
                                    ...
                                    <div>
                                        ...
                                        <?php if($order->shipping_address): ?>
                                            <div class="text-xs text-gray-500 mt-1 max-w-xs">
                                                ...
                                                <?php echo e(Str::limit($order->shipping_address, 50)); ?>
                                    ...
                                    <div class="text-sm text-gray-900">
                                        <?php $__currentLoopData = $order->orderItems->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center space-x-2 mb-1">
                                                <?php if($item->product): ?>
                                                    <span class="truncate max-w-32"><?php echo e($item->product->name); ?></span>
                                                <?php else: ?>
                                        ...
                                        <?php if($order->orderItems->count() > 2): ?>
                                            <div class="text-xs text-gray-500">+<?php echo e($order->orderItems->count() - 2); ?> more</div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td class="hidden lg:table-cell px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e(App\Models\Setting::formatPrice($order->total_amount)); ?></div>
                                ...
                                <td class="hidden xl:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-xs text-gray-400"><?php echo e($order->created_at->format('g:i A')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <!-- Delete Button -->
                                        <form method="POST" action="<?php echo e(route('admin.orders.destroy', $order)); ?>" class="inline" onsubmit="return confirm('Are you sure you want to delete this order?')">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\CascadeProjects\Market-Store - v2\mini-market\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>