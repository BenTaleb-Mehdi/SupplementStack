<?php $__env->startSection('title', 'The Catalog - Premium Supplements'); ?>
        ...
        <div class="flex flex-col lg:flex-row gap-16">
            ...
            <div class="w-full lg:w-1/4">
                <div class="sticky top-32 space-y-12">
                    <form method="GET" action="<?php echo e(route('products.list')); ?>" id="filterForm">
                        ...
                        <div class="group border-b border-slate-200 focus-within:border-primary-500 transition-all pb-2 mb-12">
                            ...
                            <div class="relative">
                                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Find your fuel..." 
                        ...
                        <div class="mb-12">
                            ...
                            <div class="space-y-4 font-bold text-sm tracking-tight uppercase">
                                <label class="flex items-center group cursor-pointer">
                                    <input type="radio" name="category" value="" class="hidden" <?php echo e(request('category') == '' ? 'checked' : ''); ?>>
                                    <span class="relative pb-1 <?php echo e(request('category') == '' ? 'text-slate-950 border-b-2 border-slate-950' : 'text-slate-300 group-hover:text-slate-500'); ?> transition-all">All Collections</span>
                                </label>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center group cursor-pointer uppercase">
                                        <input type="radio" name="category" value="<?php echo e($cat->slug); ?>" class="hidden" <?php echo e(request('category') == $cat->slug ? 'checked' : ''); ?>>
                                        <span class="relative pb-1 <?php echo e(request('category') == $cat->slug ? 'text-slate-950 border-b-2 border-slate-950' : 'text-slate-300 group-hover:text-slate-500'); ?> transition-all">
                                            <?php echo e($cat->name); ?>
                        ...
                        <a href="<?php echo e(route('products.list')); ?>" class="text-[9px] font-black uppercase tracking-widest text-red-500 hover:text-red-700 transition-colors">
                            Reset All Filters
                        </a>
                    </form>
                </div>
            ...
            <div class="w-full lg:w-3/4">
                 <?php if($products->count() > 0): ?>
                    <div class="mb-10 flex items-center justify-between border-b border-slate-50 pb-6">
                         <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            Catalogue / <span class="text-slate-900 underline underline-offset-4"><?php echo e($products->count()); ?> Items found</span>
                         </p>
                    </div>
                            ...
                            <div class="group flex flex-col h-full">
                                <div class="relative aspect-[1/1] mb-6 rounded-[2.5rem] bg-slate-50 overflow-hidden transition-all duration-700 group-hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)]">
                                    ...
                                    <div class="absolute inset-0 bg-slate-950/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-8 backdrop-blur-[2px]">
                                        <a href="<?php echo e(route('products.show', $product)); ?>" class="bg-white text-slate-950 px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                                            View Profile
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="px-2">
                                    <p class="text-[9px] font-black text-primary-600 uppercase tracking-widest mb-2"><?php echo e($product->category->name ?? 'Series'); ?></p>
                ...
                <?php else: ?>
                    <div class="py-40 text-center bg-slate-50 rounded-[3rem] border border-slate-100">
                        ...
                        <a href="<?php echo e(route('products.list')); ?>" class="mt-4 inline-block text-[10px] font-black uppercase tracking-widest underline underline-offset-8">Clear all filters</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\CascadeProjects\Market-Store - v2\mini-market\resources\views/products/list.blade.php ENDPATH**/ ?>