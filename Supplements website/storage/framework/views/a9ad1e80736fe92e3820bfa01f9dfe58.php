        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Sent on <?php echo e($message->created_at->format('F d, Y \a\t g:i A')); ?></p>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm text-gray-500">
                            From: <?php echo e($message->name); ?> (<?php echo e($message->email); ?>)
                        </span>
                    </div>
                    <span class="text-sm text-gray-500">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-blue-700 mt-2 whitespace-pre-wrap"><?php echo e($message->reply); ?></p>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden mt-6">
                ...
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('contact.store')); ?>">
                        ...
                        <input type="hidden" name="email" value="<?php echo e($message->email); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="reply_message" 
                                      ...
                                      rows="4" 
                                      required
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 <?php $__errorArgs = ['message'];
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\CascadeProjects\Market-Store - v2\mini-market\resources\views/messages/show.blade.php ENDPATH**/ ?>