<?php $__env->startSection('title', 'Shopping Cart - Mini Market'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(count($cartItems) > 0): ?>
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="flex-1">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                                <h2 class="text-lg font-bold text-gray-900">Cart Items (<?php echo e(count($cartItems)); ?>)</h2>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                                        ...
                                        <div class="w-24 h-24 flex-shrink-0 bg-gray-100 rounded-xl overflow-hidden border border-gray-200">
                                            <?php if($item['product']->image): ?>
                                                <img src="<?php echo e($item['product']->image_url); ?>" alt="<?php echo e($item['product']->name); ?>" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='<?php echo e(asset('images/placeholder.svg')); ?>';">
                                            <?php else: ?>
                                        ...
                                        <div class="flex-1 text-center sm:text-left">
                                            ...
                                            <p class="text-sm text-gray-500 mb-2"><?php echo e(ucfirst($item['product']->category)); ?></p>
                                            <div class="text-primary-600 font-bold">
                                                <?php echo e(App\Models\Setting::formatPrice($item['product']->price)); ?>
                                        ...
                                        <div class="flex items-center gap-3">
                                            <form method="POST" action="<?php echo e(route('cart.update', $item['product'])); ?>" class="flex items-center bg-gray-50 rounded-lg p-1 border border-gray-200">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="sm:text-right min-w-[100px]">
                                            ...
                                            <p class="text-lg font-bold text-gray-900"><?php echo e(App\Models\Setting::formatPrice($item['subtotal'])); ?></p>
                                        </div>
                                    </div>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('products.list')); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-700 font-medium transition-colors">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex justify-between items-center text-gray-600">
                                <span>Subtotal</span>
                                <span class="font-medium text-gray-900"><?php echo e(App\Models\Setting::formatPrice($total)); ?></span>
                            </div>
                            <div class="flex justify-between items-center text-gray-600">
                                <span>Shipping</span>
                            ...
                            <div class="border-t border-gray-100 pt-4 flex justify-between items-center text-lg font-bold text-gray-900">
                                <span>Total</span>
                                <span class="text-primary-600"><?php echo e(App\Models\Setting::formatPrice($total)); ?></span>
                            </div>
                        </div>

                        <a href="<?php echo e(route('checkout.index')); ?>" class="w-full block bg-primary-600 text-white text-center font-bold py-4 rounded-xl shadow-lg hover:bg-primary-700 hover:shadow-primary-500/30 transition-all transform hover:-translate-y-0.5">
                            Proceed to Checkout
                        </a>
        ...
        <?php else: ?>
            <div class="text-center py-24 bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                <a href="<?php echo e(route('products.list')); ?>" class="inline-flex items-center px-8 py-3 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 shadow-lg hover:shadow-primary-500/30 transition-all transform hover:-translate-y-0.5">
                    Start Shopping
                </a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\CascadeProjects\Market-Store - v2\mini-market\resources\views/cart/index.blade.php ENDPATH**/ ?>